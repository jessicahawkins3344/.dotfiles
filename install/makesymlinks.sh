...
files="bashrc bash_profile curlrc gitattributes gitconfig gitignore profile prompt-colors.sh git-prompt-colors.sh inputrc git-prompt-colors.sh nanorc nano mackup.cfg"    # list of files/folders to symlink in homedir
