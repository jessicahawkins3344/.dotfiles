...
sudo scutil --set ComputerName "Jessicas-Macbook-Air"
sudo scutil --set HostName "Jessicas-Macbook-Air"
sudo scutil --set LocalHostName "Jessicas-Macbook-Air"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Jessicas-Macbook-Air"
