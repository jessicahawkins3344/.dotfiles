...
files="bashrc bash_profile curlrc gitattributes gitconfig gitignore profile git-prompt-colors.sh inputrc git-prompt-colors.sh nanorc nano"    # list of files/folders to symlink in homedir
